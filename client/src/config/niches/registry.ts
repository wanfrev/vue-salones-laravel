...
export const NICHES: Record<string, NicheDefinition> = {
  ...
  odontologia: {
    ...
    clientProfile: {
      ...
      fields: [
        { key: 'allergies_medications', label: 'Alergias y medicamentos', type: 'textarea', placeholder: 'Alergias a medicamentos/anestesia, medicamentos actuales...' },
        { key: 'medical_conditions', label: 'Condiciones médicas relevantes', type: 'textarea', placeholder: 'Diabetes, hipertensión, embarazo, marcapasos, trastornos de coagulación...' },
        { key: 'dental_insurance', label: 'Seguro dental / HCM', type: 'input', placeholder: 'Aseguradora y número de póliza (opcional)' },
      ],
    },
    capabilities: ['dental.odontogram', 'dental.clinical_history', 'dental.endo_annex', 'dental.perio_annex'],
    featureDefaults: {},
    terminologyDefaults: {
      client: 'Paciente',
