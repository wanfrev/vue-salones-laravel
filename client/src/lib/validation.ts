...
const paymentMethodSchema = z.enum(['cash', 'cash_ves', 'card', 'transfer', 'other', 'zelle', 'binance', 'cashea', 'pago_movil', 'punto_venta', 'mixed', 'gift_card', 'credito', 'cortesia'])
...
export const serviceItemSchema = z.object({
  ...
  isFixedCommissionOverride: z.boolean().default(false),
  employeeAmountOverride: z.number().min(0).optional(),
  assistantAmountOverride: z.number().min(0).optional(),
