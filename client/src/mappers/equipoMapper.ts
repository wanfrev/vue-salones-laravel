...
export const mapProfileToEmpleado = (
  ...
  return {
    ...
    productCommissionPercentage: Number(profile.product_commission_percentage ?? 0),
    payTypeLabel,
    payValueLabel,
    disableAgenda: profile.disable_agenda ?? false,
    disableInventoryEdit: profile.disable_inventory_edit ?? false,
    showInPublicBooking: profile.show_in_public_booking ?? true,
    ...
    canAccessDentalClinical: profile.can_access_dental_clinical ?? true,
    gabineteMode: profile.gabinete_mode ?? false,
...
export const mapEmpleadoFormToProfileUpdate = (data: EmpleadoFormData) => ({
  ...
  product_commission_percentage: Number(data.productCommissionPercentage) || 0,
  ...
  show_in_public_booking: data.systemRole === 'cajero' ? false : data.showInPublicBooking,
  ...
  can_access_dental_clinical: data.systemRole === 'cajero' ? false : data.canAccessDentalClinical,
  gabinete_mode: data.systemRole === 'cajero' ? false : data.gabineteMode,
