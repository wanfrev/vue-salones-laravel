  ...
  <div class="grid grid-cols-1 gap-4 lg:grid-cols-[3fr_2fr]">
    ...
    <div class="hidden lg:sticky lg:top-20 lg:block lg:h-[calc(100vh-6rem)] lg:flex lg:flex-col lg:overflow-hidden">
      <POSPaymentPanel
        ...
        :direct-service-name="directServiceSelected?.name ?? null"
        :direct-service-employee-name="posEmpleadosList.find((e: any) => e.id === directServiceEmployeeId)?.name ?? null"
        :direct-service-assistant-name="posEmpleadosList.find((e: any) => e.id === directServiceAssistantId)?.name ?? null"
