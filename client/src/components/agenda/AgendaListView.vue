        ...
        <table class="w-full">
          <thead>
            <tr class="border-b border-border bg-bg-secondary/50">
              ...
              <th class="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-widest text-text-muted">Estado</th>
              <th class="px-4 py-3 text-right text-[11px] font-semibold uppercase tracking-widest text-text-muted">Acciones</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-border">
            <tr
              v-for="cita in citas"
              :key="cita.id"
              class="group transition-theme hover:bg-bg-secondary/30"
            >
              <td class="px-4 py-3">
