<template>
  <div class="space-y-3">
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
      ...
      />
      <FormSelect
        :model-value="formData.salaryFrequency"
