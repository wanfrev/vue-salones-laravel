<template>
  <ModalBase :is-open="isOpen" title="Ajustar stock" subtitle="Agrega o reduce la cantidad disponible"
    icon="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"
    size="sm" confirm-text="Guardar ajuste" :is-loading="isLoading" :is-confirm-disabled="quantity === 0 || isLoading"
    ...
    <div class="space-y-4">
      ...
      <FormInput v-model.number="quantity" label="Cantidad a ajustar" type="number" placeholder="Ej: 5 o -3"
      ...
      <FormInput v-model="notes" label="Motivo del ajuste" placeholder="Ej: Compra nueva, producto dañado..."
