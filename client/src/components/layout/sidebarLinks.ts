...
export const sidebarSections: SidebarSection[] = [
  {
    links: [
      ...
      { to: '/admin/requerimientos', label: 'Requerimientos', icon: DocumentIcon, adminOnly: true, gate: { capability: 'catalog.requirements', profileFlag: 'can_access_requirements' } },
