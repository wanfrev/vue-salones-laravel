...
export const sidebarSections: SidebarSection[] = [
  {
    links: [
      ...
      { to: '/dashboard/calendario', label: 'Calendario', icon: CalendarIcon, employeeOnly: true, gate: { hideIfAgendaDisabled: true } },
      { to: '/admin', label: 'Agenda', icon: CalendarIcon, adminOnly: true },
      { to: '/dashboard/agenda', label: 'Agenda', icon: CalendarIcon, employeeOnly: true, gate: { hideIfAgendaDisabled: true } },
