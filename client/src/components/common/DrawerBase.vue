    ...
    >
      ...
      >
        ...
        >
          <div
            v-if="isOpen"
            class="fixed top-0 h-full w-full overflow-hidden bg-surface shadow-2xl sm:w-96"
          ...
          >
            ...
            <!-- Footer -->
            <div v-if="showFooter" class="absolute bottom-0 left-0 right-0 flex items-center justify-end gap-3 border-t border-border bg-surface px-6 py-4">
              <slot name="footer">
                <button
                  @click="handleCancel"
