  ...
  >
    <form @submit.prevent="handleSubmit" class="space-y-5">
      ...
      <div class="space-y-3">
        ...
        />
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-[145px_1fr_140px] items-start min-w-0">
          <FormInput v-model="formData.date" label="Fecha" type="date" required
            prefix-icon="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" :error="errors.date" class="w-[145px] max-w-[145px] shrink-0" />
          <FormTime v-model="formData.time" label="Hora" required :error="errors.time" class="flex-1 min-w-0" />
          <FormDropdown v-model="formData.status" label="Estado" :options="statusOptions" required :error="errors.status" class="w-full sm:w-[140px] shrink-0" />
        </div>
      </div>
