...
export type PaymentMethod = 'cash' | 'cash_ves' | 'card' | 'transfer' | 'other' | 'zelle' | 'binance' | 'cashea' | 'pago_movil' | 'punto_venta' | 'mixed' | 'gift_card' | 'credito' | 'cortesia'
...
export interface StaffingTimesheetEntry {
  ...
  /** Entered as a total dollar amount directly — folded into net/payout, never billed. */
