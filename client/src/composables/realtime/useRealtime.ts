...
export function useRealtime() {
  ...
  const handleEntityChange = (payload: EntityChangedPayload) => {
    ...
    const queryKeyMap: Record<string, string[]> = {
      ...
      supplier_payment: ['supplier-payments', 'suppliers', 'financial-summary'],
      credit: ['credits', 'finanzas-transactions', 'financial-summary', 'pos-pending'],
      inventory: ['inventario', 'productos', 'products', 'pos-products'],
      inventory_stock: ['inventario', 'productos', 'products', 'pos-products'],
      inventory_movement: ['inventario', 'finanzas-product-sales', 'productos', 'products', 'pos-products'],
