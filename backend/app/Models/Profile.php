...
class Profile extends Model
{
    ...
    protected $fillable = [
        ...
        'employee_ves_rate',
        'disable_agenda', 'disable_inventory_edit', 'show_in_public_booking',
        'can_create_appointments', 'can_create_clients',
        'can_access_consultorio', 'can_access_dental_clinical', 'gabinete_mode',
        'can_access_inventory', 'can_access_pos', 'can_access_suppliers', 'can_access_finanzas', 'can_access_requirements',
        'can_add_purchase_invoice', 'can_access_spreadsheet',
