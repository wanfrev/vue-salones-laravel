...
Route::middleware(['auth:sanctum', 'business-context'])->group(function () {
    ...
    Route::middleware(['capability:staffing.reports', 'admin-panel'])->group(function () {
        ...
        Route::delete('/staffing-tax-entries/{id}/file', [StaffingTaxEntryController::class, 'destroyFile']);
        ...
        Route::get('/staffing-annual-taxes/employee/{employeeId}/download', [\App\Http\Controllers\Api\Staffing\StaffingAnnualTaxController::class, 'download']);
        Route::delete('/staffing-annual-taxes/employee/{employeeId}', [\App\Http\Controllers\Api\Staffing\StaffingAnnualTaxController::class, 'destroyFile']);
