...
class SalonesPruebaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $adminEmail = 'salones@prueba.com';

        if (DB::table('users')->where('email', $adminEmail)->exists()) {
            $this->command->info('salones@prueba.com ya existe, saltando...');
            return;
        }
        ...
        // ── Business (nicho mixto: barbería + salón + spa) ──
        DB::table('businesses')->insert([
            'id' => $bizId, 'name' => 'Salones Prueba', 'slug' => 'salones-prueba-' . substr($bizId, 0, 8),
            'phone' => '+584141234567', 'address' => 'Av. Principal, Centro Comercial, Piso 1',
            'timezone' => 'America/Santo_Domingo', 'currency' => 'USD',
            'ves_exchange_rate' => 36.5, 'niche_type' => 'mixto',
            ...
            'job_titles' => json_encode(['Barbero', 'Estilista', 'Colorista', 'Manicurista', 'Esteticista']),
            'service_categories' => json_encode([
                ['id' => 'cat1', 'name' => 'Corte'], ['id' => 'cat2', 'name' => 'Barba'],
                ['id' => 'cat3', 'name' => 'Color'], ['id' => 'cat4', 'name' => 'Uñas'],
                ['id' => 'cat5', 'name' => 'Spa'],
            ]),
            ...
            'product_price1_markup' => 50, 'product_price2_markup' => 70,
            'active' => true, 'created_at' => $now, 'updated_at' => $now,
        ]);

        // ── Admin user ──
        DB::table('users')->insert([
            'id' => $adminId, 'name' => 'Admin Salones Prueba', 'email' => $adminEmail,
            'password' => bcrypt('password'), 'created_at' => $now, 'updated_at' => $now,
        ]);
        DB::table('profiles')->insert([
            'id' => $adminId, 'business_id' => $bizId, 'full_name' => 'Admin Salones Prueba',
            'role' => 'admin', 'email' => $adminEmail, 'active' => true, 'created_at' => $now, 'updated_at' => $now,
        ]);

        // ── Branch ──
        DB::table('branches')->insert([
            'id' => $branchId, 'business_id' => $bizId, 'name' => 'Principal',
            'address' => 'Av. Principal, CC Salones Prueba, Piso 1', 'is_default' => true, 'active' => true,
            'created_at' => $now, 'updated_at' => $now,
        ]);

        // ── Employees (6) ──
        $employees = [
            ['name' => 'Luis Barrios', 'email' => 'luis.barbero@prueba.com', 'pay_type' => 'percentage', 'pay_percentage' => 50, 'job_title' => 'Barbero'],
            ['name' => 'Carla Ferrer', 'email' => 'carla.estilista@prueba.com', 'pay_type' => 'percentage', 'pay_percentage' => 50, 'job_title' => 'Estilista'],
            ['name' => 'Rosa Medina', 'email' => 'rosa.colorista@prueba.com', 'pay_type' => 'percentage', 'pay_percentage' => 45, 'job_title' => 'Colorista'],
            ['name' => 'Yulimar Pérez', 'email' => 'yuli.manicurista@prueba.com', 'pay_type' => 'mixed', 'pay_percentage' => 30, 'base_salary' => 200, 'job_title' => 'Manicurista'],
            ['name' => 'Diego Aponte', 'email' => 'diego.barbero@prueba.com', 'pay_type' => 'percentage', 'pay_percentage' => 50, 'job_title' => 'Barbero'],
            ['name' => 'Marielba Soto', 'email' => 'marielba.esteticista@prueba.com', 'pay_type' => 'salary', 'base_salary' => 400, 'pay_percentage' => 0, 'job_title' => 'Esteticista'],
        ];
        ...
        $this->command->info('6 empleados creados');
        ...
        foreach ($clientNames as $i => $name) {
            ...
            DB::table('clients')->insert([
                ...
                'full_name' => $name, 'phone' => '+58424222' . str_pad($i, 4, '0', STR_PAD_LEFT),
                'created_at' => $now, 'updated_at' => $now,
            ]);
        }
        $this->command->info('20 clientes creados');

        // ── Services (12): barbería + salón + spa ──
        $services = [
            ['name' => 'Corte clásico', 'category' => 'Corte', 'price' => 15, 'duration' => 30],
            ['name' => 'Corte + Barba', 'category' => 'Corte', 'price' => 25, 'duration' => 45],
            ['name' => 'Fade + diseño', 'category' => 'Corte', 'price' => 20, 'duration' => 40],
            ['name' => 'Arreglo de barba', 'category' => 'Barba', 'price' => 10, 'duration' => 20],
            ['name' => 'Afeitado clásico', 'category' => 'Barba', 'price' => 12, 'duration' => 25],
            ...
            ['name' => 'Masaje relajante', 'category' => 'Spa', 'price' => 35, 'duration' => 50],
            ['name' => 'Limpieza facial', 'category' => 'Spa', 'price' => 30, 'duration' => 40],
        ...
        $this->command->info('12 servicios creados');

        // ── Products (16) + categories (6) ──
        $categories = ['Shampoo', 'Acondicionador', 'Tintes', 'Herramientas', 'Cuidado', 'Spa'];
        $catIds = [];
        ...
        $products = [
            ...
            ['name' => 'Máquina de cortar cabello', 'cat' => 3, 'cost' => 45, 'price' => 90],
            ['name' => 'Tijeras profesionales', 'cat' => 3, 'cost' => 25, 'price' => 50],
            ['name' => 'Pomada para barba', 'cat' => 4, 'cost' => 6, 'price' => 12],
            ['name' => 'Aceite para barba', 'cat' => 4, 'cost' => 5, 'price' => 10],
            ['name' => 'Cera moldeadora 150ml', 'cat' => 4, 'cost' => 5, 'price' => 10],
            ['name' => 'Gel fijador 200ml', 'cat' => 4, 'cost' => 5, 'price' => 10],
            ['name' => 'Aceite esencial para masajes', 'cat' => 5, 'cost' => 9, 'price' => 18],
            ['name' => 'Mascarilla facial', 'cat' => 5, 'cost' => 7, 'price' => 15],
            ['name' => 'Vela aromática', 'cat' => 5, 'cost' => 4, 'price' => 9],
            ['name' => 'Kit de manicure desechable', 'cat' => 4, 'cost' => 1, 'price' => 3],
        ...
        $this->command->info('16 productos con stock creados');
        ...
        DB::table('suppliers')->insert([
            ...
            ['id' => $sup2, 'business_id' => $bizId, 'first_name' => 'Importadora', 'last_name' => 'Belleza y Spa', 'company' => 'Imp. Belleza y Spa', 'phone' => '+582123334444', 'active' => true, 'created_at' => $now, 'updated_at' => $now],
        ]);
        ...
        $this->command->info("24 citas + {$txCount} transacciones creadas");

        // ── Direct product sale (venta de mostrador sin cita, para probar el POS de tienda) ──
        $saleDate = now()->subDays(1);
        $saleTotal = $products[0]['price'] + $products[1]['price'];
        ...
        $this->command->info('1 venta directa de ejemplo creada');
